          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                  ...
                  <a href="#" class="fs-5" id="restore" data-bs-toggle="modal" data-new="{{$data->expense_id}}" data-bs-target="#restoreModal"><i class="fas fa-recycle mx-2 text-success"></i>  </a> 

                  <a href="#" class="fs-5"  id="delete" data-bs-toggle="modal" data-new="{{$data->expense_id}}" data-bs-target="#deleteModal"><i class="fas fa-trash text-danger"></i></a>
...
<div class="modal fade" id="restoreModal" tabindex="-1" aria-labelledby="restoreModalLabel" aria-hidden="true">
   <div class="modal-dialog">
      <form action="{{route('restore-expense') }}" method="post">
         @csrf
