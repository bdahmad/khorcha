      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          ...
          <div class="row mb-3 {{ $errors->has('income_title')?'has-error':'' }}">
            ...
            <div class="col-sm-7">
              <input type="text" class="form-control form_control" id="" name="income_title" {{ old('income_title') }}>
          ...
          <div class="row mb-3 {{ $errors->has('income_category')?'has-error':'' }}">
            ...
            <div class="col-sm-7">
              <select name="income_category" id="" class="form-control form_control">
                ...
                @foreach($all as $data)
                  <option value="{{$data->income_cate_id}}">{{$data->income_cate_name}}</option>
                @endforeach
              </select>
          ...
          <div class="row mb-3 {{ $errors->has('income_amount')?'has-error':'' }}">
            ...
            <div class="col-sm-7">
            <input type="text" class="form-control form_control" id="" name="income_amount" {{ old('income_amount') }}>
          ...
          <div class="row mb-3 {{ $errors->has('income_date')?'has-error':'' }}">
            ...
            <div class="col-sm-7">
            <input type="text" class="form-control form_control" id="date" name="income_date" {{ old('income_date') }}>
